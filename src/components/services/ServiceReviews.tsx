...
export default function ServiceReviews({
  ...
  return (
    <section className="border-b border-neutral-200 pb-10 pt-10" id="service-reviews-section">
      <div className="space-y-6">
        ...
        <form onSubmit={handleAddReview} className="space-y-6 pt-6">
          ...
          <div className="space-y-2">
            <label htmlFor="service-review-comment" className="block text-sm font-normal text-black">
              Comment
            </label>
            <textarea
