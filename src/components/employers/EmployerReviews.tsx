...
const INITIAL_REVIEWS_MAP: Record<string, SingleReview[]> = {
  'emp-invision-1': [
    {
      id: 'rev-inv-1',
      ...
      date: 'May 20, 2026',
      comment:
        'Invision is a fantastic place to work with on freelance contracts. Their design brief, system components, and assets are exceptionally structured. The project coordination was fluid with milestones clearly outlined. Payment holds were processed instantly upon final delivery.',
      likes: 12,
      dislikes: 1,
    },
    {
      ...
      date: 'April 12, 2026',
      comment:
        'Excellent experience. The code handoffs were clean and the project feedback loop was highly actionable. Had a slight delay on the server credential setup, but creative collaboration was top tier and extremely pleasant throughout.',
      likes: 8,
      dislikes: 0,
    },
    {
      ...
      date: 'March 29, 2026',
      comment:
        'Outstanding freelance experience. The creative team gave me a robust blueprint and had very small revision requirements. Highly recommend working with their marketing crew!',
      likes: 5,
      dislikes: 0,
    },
  ],
  'emp-mailchimp-2': [
    {
      ...
      reviewerRole: 'React Native Developer',
      rating: 5,
      date: 'June 01, 2026',
      comment:
        'Mailchimp team provided great technical specs for their dashboard mockup design project. Very pleasant workflow and extremely rapid response rates inside internal Slack channels.',
      likes: 15,
      dislikes: 0,
    },
    {
      ...
      reviewerRole: 'Figma Designer',
      rating: 4,
      date: 'May 15, 2026',
      comment:
        'Loved working on these brand assets. Creative director has incredibly sharp taste, although reviews could take a day because of time zone differences. Pay rate is extremely competitive.',
      likes: 6,
      dislikes: 1,
    },
  ],
  ...
  'emp-slack': [
    {
      ...
      date: 'June 05, 2026',
      comment:
        'Slack technologies defines the gold-standard client integration workflow. We automated all deployment metrics using their custom webhooks. Superb support from their internal infrastructure leads.',
      likes: 24,
      dislikes: 0,
    },
  ],
  'emp-stripe': [
    {
      ...
      reviewerRole: 'Backend Developer',
      rating: 5,
      date: 'June 08, 2026',
      comment:
        'Stripe team is world-class. Absolute delight to collaborate with. Clear API documentations, seamless sandbox permissions, and extremely high focus on secure code structures. Payments were prompt.',
      likes: 42,
      dislikes: 0,
    },
  ],
...
const getFallbackReviews = (empName: string): SingleReview[] => [
  {
    id: 'rev-fall-1',
    reviewerName: 'Jane Cooper',
    reviewerRole: 'Digital Specialist',
    rating: 5,
    date: 'May 18, 2026',
    comment: `Collaborating with ${empName} has been a highly professional and positive experience. The deliverables were clearly defined, questions were answered promptly, and payments were released strictly on schedule.`,
    likes: 4,
    dislikes: 0,
  },
  {
    ...
    reviewerRole: 'UI/UX Consultant',
    rating: 4,
    date: 'April 24, 2026',
    comment:
      'Excellent design parameters were shared ahead of time, ensuring we could map and implement the prototype files on schedule. Friendly communication throughout the process.',
    likes: 2,
    dislikes: 0,
  },
];
